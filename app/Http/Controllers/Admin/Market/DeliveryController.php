...
class DeliveryController extends Controller
{
    ...
    public function store(DeliveryRequest $request)
    {
        ...
        return redirect()->route('admin.market.delivery.index')->with('text' , 'با موفقیت ایجاد گردید');
    }
    ...
    public function update(DeliveryRequest $request, Delivery $delivery)
    {
        ...
        return redirect()->route('admin.market.delivery.index')->with('text' , 'با موفقیت ویرایش شد');
    }
    ...
    public function destroy(Delivery $delivery)
    {
       ...
       return redirect()->route('admin.market.delivery.index')->with('text' , 'با موفقیت حذف شد');
    }
