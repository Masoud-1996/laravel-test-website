...
class PropertyController extends Controller
{
    ...
    public function store(CategoryAttributeRequest $request)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('text', 'فرم جدید شما با موفقیت ثبت شد');
    }
    ...
    public function update(CategoryAttributeRequest $request, CategoryAttribute $categoryAttribute)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('text', 'فرم شما با موفقیت ویرایش شد');
    }
    ...
    public function destroy(CategoryAttribute $categoryAttribute)
    {
        ...
        return redirect()->route('admin.market.property.index')->with('text', 'فرم شما با موفقیت حذف شد');
    }
}
