...
class RoleController extends Controller
{
    ...
    public function store(RoleRequest $request)
    {
        ...
        return redirect()->route('admin.user.role.index')->with('text' , 'با موفقیت ایجاد گردید');
    }
    ...
    public function update(RoleRequest $request, Role $role)
    {
        $inputs = $request->all();
        $role->update($inputs);
        return redirect()->route('admin.user.role.index')->with('text' , 'با موفقیت ویرایش شد');
    }
    ...
    {
        $result = $role->delete();
        return redirect()->route('admin.user.role.index')->with('text' , 'با موفقیت حذف شد');
    }
