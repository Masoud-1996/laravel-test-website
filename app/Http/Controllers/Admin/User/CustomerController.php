...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request, ImageService $imageService)
    {
        ...
        return redirect()->route('admin.user.customer.index')->with('text' , 'با موفقیت ایجاد گردید');
    }
    ...
    public function update(CustomerRequest $request, User $user, ImageService $imageService)
    {
        ...
        $user->update($inputs);
        return redirect()->route('admin.user.customer.index')->with('text' , 'با موفقیت ویرایش شد');
    }
    /**
    ...
    public function destroy(User $user)
    {
        ...
        return redirect()->route('admin.user.customer.index')->with('text' , 'با موفقیت حذف شد');
    }
}