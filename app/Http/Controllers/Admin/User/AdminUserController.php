...
class AdminUserController extends Controller
{
    ...
    public function store(AdminUserRequest $request , ImageService $imageService)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('text' , 'با موفقیت ایجاد گردید');
    }
    ...
    public function update(AdminUserRequest $request , User $admin , ImageService $imageService)
    {
        ...
        $admin->update($inputs);
        return redirect()->route('admin.user.admin-user.index')->with('text' , 'با موفقیت ویرایش شد');
    }
    ...
    public function destroy(User $admin)
    {
        ...
        return redirect()->route('admin.user.admin-user.index')->with('text' , 'با موفقیت حذف شد');
    }
}
