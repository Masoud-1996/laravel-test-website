...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        ...
        return redirect()->route('admin.content.menu.index')->with('text' , 'با موفقیت ایجاد گردید');
    }
    ...
    public function update(MenuRequest $request, Menu $menu)
    {
        ...
        $menu->update($inputs);
        return redirect()->route('admin.content.menu.index')->with('text' , 'با موفقیت ویرایش شد');
    ...
    {
        $result = $menu->delete();
        return redirect()->route('admin.content.menu.index')->with('text' , 'با موفقیت حذف شد');  
