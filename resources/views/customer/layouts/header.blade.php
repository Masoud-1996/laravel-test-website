            ...
            <section class="container-xxl ">
                <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="d-flex justify-content-between align-items-center d-md-block">
                        <a class="text-decoration-none" href="{{ route('customer.home')}}"><i class="fas fa-home text-success"></i></a>
                        ...
                        <section class="d-inline px-md-3">
                            ...
                            <section class="d-inline px-md-3">
                                ...
                                <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                    <section><a class="dropdown-item" href="{{ route('admin.home')}}"><i class="fa fa-user-circle"></i> پنل ادمین</a></section>
                                </section>                           
                            </section>

                            <button class="btn btn-link text-decoration-none text-warning dropdown-toggle profile-button" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down" aria-labelledby="dropdownMenuButton1">
                                ...
                                <section><a class="dropdown-item" href="{{ route('auth.customer.logout') }}">
                                    <i class="fa fa-sign-out-alt"></i>خروج</a></section>
