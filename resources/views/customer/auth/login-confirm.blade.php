...
@section('content')
    <section class="vh-100 d-flex justify-content-center align-items-center pb-5">
        ...
        <form action="{{ route('auth.customer.login-confirm', $token) }}" method="post">
            @csrf
            <section class="form-control mb-5">

                <section class="login-logo">
                    <img src="{{ asset('customer-assets/images/logo/test.jpg') }}" alt="">
                </section>
                ...
                <section class="login-input-text">
                    ...
                    @error('otp')
                        <span class="alert_reqiured bg-primary p-1 rounded text-white" role="alert">
                            <strong>
                                {{ $message }}
                            </strong>
                        </span>
                ...
                <section class="login-btn d-grid g-2"><button class="btn btn-warning"> تایید </button></section>

                <section id="resend-otp" class="d-none">

                    <a href="{{ route('auth.customer.login-resend-otp', $token) }}"
                        class=" text-decoration-none text-primary">
                        دریافت مجدد کد تایید</a>
                </section>

                <section id="timer" class="text-danger"></section>
            </section>
        </form>
    </section>
@endsection
