                             ...
                             <section class="col-12 col-md-6 my-2">
                                 <div class="form-group">
                                     ...
                                     <select name="show_in_menu" id="" class="form-control form-control-sm"
                                         id="show_in_menu">
                                         <option value="0" @if (old('show_in_menu', $productCategory->status) == 0) selected @endif>غیرفعال
                                         </option>
                                         <option value="1" @if (old('show_in_menu', $productCategory->status) == 1) selected @endif>فعال
                                         </option>
                                     </select>
                                 </div>
                                 @error('show_in_menu')
                             ...
                             <section class="col-12 col-md-6 my-2">
                                 <div class="form-group">
                                     ...
                                     <input type="hidden" class="form-control form-control-sm" name="tags"
                                         id="tags" value="{{ old('tags', $productCategory->tags) }}">
